...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUES 
            (@CategoryHardware, 'Bitget Web3 Vault', '冷存储签名器', '专为 Bitget 用户打造的硬件 Vault，提供安全的冷存储解决方案', NULL, 399.00, 'USDT', 1, 'BG-VLT-001', 1, @Now, @Now),
            (@CategoryDigital, 'Bitget Genesis NFT', '限量 Genesis 系列', 'Bitget 生态限量 Genesis NFT，具有独特的收藏价值', NULL, 129.00, 'USDT', 137, 'BG-NFT-001', 1, @Now, @Now),
            (@CategoryService, '链上风控加速', '链上风控增强服务', '快速提升企业链上风控能力，保障资产安全', NULL, 259.00, 'USDT', 56, 'BG-SRV-001', 1, @Now, @Now),
            (@CategoryHardware, 'Web3 安全钱包', '多链支持硬件钱包', '支持 Ethereum、Polygon、BSC 等多条链的硬件钱包', NULL, 299.00, 'USDT', 1, 'BG-WLT-002', 1, @Now, @Now),
            (@CategoryDigital, 'Bitget 纪念 NFT', '平台纪念系列', 'Bitget 平台纪念 NFT，限量发行 1000 枚', NULL, 89.00, 'USDT', 137, 'BG-NFT-002', 1, @Now, @Now),
            (@CategoryService, '智能合约审计服务', '专业安全审计', '提供专业的智能合约安全审计服务，保障合约安全', NULL, 599.00, 'USDT', 1, 'BG-SRV-002', 1, @Now, @Now);
