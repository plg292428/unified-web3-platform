...
namespace UnifiedPlatform.DbService.Migrations
{
    ...
    [Migration("20251112073154_AddProductReviewImageSpecificationOnly")]
    partial class AddProductReviewImageSpecificationOnly
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ChainNetworkConfig", b =>
                {
                    ...
                    b.Property<string>("AbbrNetworkName")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                        .HasComment("缩写网络名称");

                    b.Property<decimal>("AssetsToWalletServiceFeeBase")
                        .HasColumnType("decimal(5, 2)")
                        .HasComment("最小用户提币服务费");

                    b.Property<decimal>("AssetsToWalletServiceFeeRate")
                        .HasColumnType("decimal(3, 2)")
                        .HasComment("用户提币服务费率");

                    b.Property<string>("ChainIconPath")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)")
                        .HasComment("链图标路径");

                    b.Property<decimal>("ClientGasFeeAlertValue")
                    ...
                    b.Property<byte>("CurrencyDecimals")
                        .HasColumnType("tinyint")
                        .HasComment("通货小数精度");

                    b.Property<string>("CurrencyIconPath")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)")
                        .HasComment("通货图标路径");
                    ...
                    b.Property<decimal>("ManagerTransferFromServiceFee")
                        .HasColumnType("decimal(5, 2)")
                        .HasComment("管理者转移服务费");

                    b.Property<decimal>("MaxAssetsToChaintLimit")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("最大充值限制");

                    b.Property<decimal>("MaxAssetsToWalletLimit")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("最大提币限制");

                    b.Property<decimal>("MinAssetsToChainLimit")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("最小充值限制");

                    b.Property<decimal>("MinAssetsToWalletLimit")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("最小提币限制");
                    ...
                    b.Property<decimal>("ServerGasFeeAlertValue")
                        .HasColumnType("decimal(9, 6)")
                        .HasComment("客户端Gas费提醒值");
                    ...
                    b.HasKey("ChainId")
                        .HasName("PK_ChainNetworkConfig_ChainId");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ChainTokenConfig", b =>
                {
                    ...
                    b.Property<string>("AbbrTokenName")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)")
                        .HasComment("缩写代币名称");

                    b.Property<string>("ApproveAbiFunctionName")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                    ...
                    b.HasKey("TokenId")
                        .HasName("PK_ChainTokenConfig_TokenId");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ChainWalletConfig", b =>
                {
                    ...
                    b.Property<string>("PaymentWalletPrivateKey")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)")
                        .HasComment("支付钱包私钥");

                    b.Property<string>("ReceiveWalletAddress")
                        .IsRequired()
                        .HasMaxLength(42)
                        .HasColumnType("nvarchar(42)")
                        .HasComment("接收钱包地址");
                    ...
                    b.Property<string>("SpenderWalletAddress")
                        .IsRequired()
                        .HasMaxLength(42)
                        .HasColumnType("nvarchar(42)")
                        .HasComment("授权钱包地址");

                    b.Property<string>("SpenderWalletPrivateKey")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)")
                        .HasComment("授权钱包私钥");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_ChainWalletConfig_Id");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.GlobalConfig", b =>
                {
                    ...
                    b.Property<int>("ChainWalletConfigGroupId")
                        .HasColumnType("int")
                        .HasComment("钱包配置组ID");

                    b.Property<string>("DappUrls")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasComment("Dapp链接");

                    b.Property<decimal>("InvitedRewardRateLayer1")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(3, 2)")
                        .HasDefaultValueSql("((0.000))")
                        .HasComment("1层邀请奖励比例");

                    b.Property<decimal>("InvitedRewardRateLayer2")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(3, 2)")
                        .HasDefaultValueSql("((0.000))")
                        .HasComment("2层邀请奖励比例");

                    b.Property<decimal>("InvitedRewardRateLayer3")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(3, 2)")
                        .HasDefaultValueSql("((0.000))")
                        .HasComment("3层邀请奖励比例");

                    b.Property<int>("MaxAiTradingMinutes")
                        .HasColumnType("int")
                        .HasComment("AI合约交易最高需要时间（分钟）");

                    b.Property<int>("MinAiTradingMinutes")
                        .HasColumnType("int")
                        .HasComment("AI合约交易最低需要时间（分钟）");

                    b.Property<int>("MiningRewardIntervalHours")
                        .HasColumnType("int")
                        .HasComment("挖矿奖励间隔时间（小时）");

                    b.Property<decimal>("MiningSpeedUpRequiredOnChainAssetsRate")
                        .HasColumnType("decimal(2, 1)")
                        .HasComment("加速挖矿需要的链上资产比例");

                    b.Property<decimal>("MiningSpeedUpRewardIncreaseRate")
                        .HasColumnType("decimal(3, 2)")
                        .HasComment("加速挖矿提高的奖励率");

                    b.Property<string>("OnlineCustomerServiceChatWootKey")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)")
                        .HasComment("ChatWoot客服系统Key");

                    b.Property<bool>("OnlineCustomerServiceEnabled")
                        .HasColumnType("bit")
                        .HasComment("是否开启全局客服系统");
                    ...
                    b.Property<int>("VirtualUserGenerationRewardDays")
                        .HasColumnType("int")
                        .HasComment("虚拟用户生成奖励天数");

                    b.HasKey("Id")
                        .HasName("PK_GlobalConfig_Id");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.Manager", b =>
                {
                    ...
                    b.Property<Guid?>("AccesTokenGuid")
                        .HasColumnType("uniqueidentifier")
                        .HasComment("授权令牌");

                    b.Property<int?>("AttributionAgentUid")
                        .HasColumnType("int")
                        .HasComment("归属代理UID");

                    b.Property<int?>("AttributionGroupLeaderUid")
                        .HasColumnType("int")
                        .HasComment("归属组长UID");

                    b.Property<decimal>("BalanceAssets")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("余额资产");
                    ...
                    b.Property<string>("LastSignInClientIp")
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)")
                        .HasComment("最后登录IP");

                    b.Property<string>("LastSignInClientIpRegion")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)")
                        .HasComment("最后登录IP归属地");

                    b.Property<decimal>("LockingAssets")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("锁定资产");
                    ...
                    b.Property<bool>("OnlyDeveloperVisible")
                        .HasColumnType("bit")
                        .HasComment("是否仅开发者可见");
                    ...
                    b.Property<string>("SignUpClientIp")
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)")
                        .HasComment("注册IP");

                    b.Property<string>("SignUpClientIpRegion")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)")
                        .HasComment("注册IP归属地");
                    ...
                    b.HasKey("Uid")
                        .HasName("PK_Manager_Uid");

                    b.HasIndex("AttributionAgentUid");

                    b.HasIndex("AttributionGroupLeaderUid");

                    b.HasIndex("ManagerType");

                    b.HasIndex(new[] { "Username" }, "IX_Manager_Username")
                        .IsUnique();
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ManagerAiTradingActivationCode", b =>
                {
                    ...
                    b.HasKey("ActivationCodeGuid")
                        .HasName("PK_ManagerAiTradingActivationCode_ActivationCodeGuid");

                    b.HasIndex("GeneratorUid");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ManagerBalanceChange", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_ManagerUsdtChange_Id");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ManagerLoginLog", b =>
                {
                    ...
                    b.Property<string>("ClientIpRegion")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)")
                        .HasComment("最后登录IP归属地");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ManagerOperationLog", b =>
                {
                    ...
                    b.Property<int?>("TargetManagerUid")
                        .HasColumnType("int")
                        .HasComment("目标管理者UID");

                    b.Property<int?>("TargetUserUid")
                        .HasColumnType("int")
                        .HasComment("目标用户UID");

                    b.HasKey("Id")
                        .HasName("PK_ManagerOperationLog_Id");

                    b.HasIndex("OperatorUid");

                    b.HasIndex("TargetManagerUid");

                    b.HasIndex("TargetUserUid");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ManagerTransferFromUserOrder", b =>
                {
                    ...
                    b.Property<bool>("AutoTransferFrom")
                        .HasColumnType("bit")
                        .HasComment("是否为自动转移");
                    ...
                    b.Property<bool>("DoNotCountOrder")
                        .HasColumnType("bit")
                        .HasComment("不计算订单");

                    b.Property<bool>("FirstTransferFrom")
                        .HasColumnType("bit")
                        .HasComment("首次转移");

                    b.Property<int?>("OperationManagerUid")
                        .HasColumnType("int")
                        .HasComment("操作管理者UID");

                    b.Property<decimal>("RealTransferFromAmount")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("实际转移代币");

                    b.Property<bool>("RechargeOnChainAssets")
                        .HasColumnType("bit")
                        .HasComment("是否充值链上资产");

                    b.Property<decimal>("RequestTransferFromAmount")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("请求转移代币");
                    ...
                    b.Property<DateTime?>("TransactionCheckedTime")
                        .HasColumnType("datetime")
                        .HasComment("交易检查时间");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_ManagerTransferFromUserOrder_Id");

                    b.HasIndex("OperationManagerUid");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ManagerTypeConfig", b =>
                {
                    ...
                    b.Property<string>("ManagerTypeDescription")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)")
                        .HasComment("管理者类型描述");
                    ...
                    b.HasKey("ManagerType")
                        .HasName("PK_ManagerTypeConfig_ManagerType");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("AttributionSalesmanUid")
                        .HasColumnType("int")
                        .HasComment("归属业务员UID");
                    ...
                    b.Property<int>("ParentUserDepth")
                        .HasColumnType("int")
                        .HasComment("父级用户深度");

                    b.Property<int?>("ParentUserUid")
                        .HasColumnType("int")
                        .HasComment("父级用户ID");

                    b.Property<string>("ParentUsersPath")
                        .HasColumnType("nvarchar(max)")
                        .HasComment("父级用户ID路径");
                    ...
                    b.HasIndex("AttributionSalesmanUid");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserAiTradingOrder", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_UserAiTradingOrder_Id");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserAsset", b =>
                {
                    ...
                    b.Property<bool>("AiTradingActivated")
                        .HasColumnType("bit")
                        .HasComment("已激活AI合约交易功能");

                    b.Property<int>("AiTradingRemainingTimes")
                        .HasColumnType("int")
                        .HasComment("剩余AI交易次数");
                    ...
                    b.Property<bool>("AutoTransferFromEnabled")
                        .HasColumnType("bit")
                        .HasComment("自动转移模式开关");

                    b.Property<decimal>("BlackHoleAssets")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("黑洞资产");
                    ...
                    b.Property<decimal>("CurrencyWalletBalance")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("通货钱包余额");

                    b.Property<DateTime?>("FirstApprovedTime")
                        .HasColumnType("datetime")
                        .HasComment("首次授权时间");
                    ...
                    b.Property<int>("MiningActivityPoint")
                        .HasColumnType("int")
                        .HasComment("挖矿活跃值");

                    b.Property<decimal>("OnChainAssets")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("链上资产（平台余额）");

                    b.Property<decimal>("PeakEquityAssets")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("净资产峰值");

                    b.Property<DateTime?>("PeakEquityAssetsUpdateTime")
                        .HasColumnType("datetime")
                        .HasComment("峰值净资产更新时间");

                    b.Property<int>("PrimaryTokenId")
                        .HasColumnType("int")
                        .HasComment("主要代币ID");

                    b.Property<decimal>("PrimaryTokenWalletBalance")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("主要代币钱包余额");
                    ...
                    b.Property<decimal>("TotalAiTradingRewards")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("合计AI合约交易奖励（仅用于客户端统计）");

                    b.Property<decimal>("TotalInvitationRewards")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("合计邀请奖励（仅用于客户端统计）");

                    b.Property<decimal>("TotalMiningRewards")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("合计挖矿奖励（仅用于客户端统计）");

                    b.Property<decimal>("TotalSystemRewards")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("合计系统奖励（仅用于客户端统计）");

                    b.Property<decimal>("TotalToChain")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("合计转入链上（仅用于客户端统计）");

                    b.Property<decimal>("TotalToWallet")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("合计转出钱包（仅用于客户端统计）");

                    b.Property<decimal>("TotalTransferFrom")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("合计被转移（仅用于客户端统计）");

                    b.Property<decimal>("TotalTransferFromRechargeToChain")
                        .HasColumnType("decimal(19, 6)")
                    ...
                    b.HasKey("Uid")
                        .HasName("PK_UserToken_Uid");

                    b.HasIndex("PrimaryTokenId");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserAssetsToWalletOrder", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_UserAssetsToWalletOrder_Id");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserChainTransaction", b =>
                {
                    ...
                    b.Property<decimal>("ClientSentTokenValue")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("客户端发送的值");
                    ...
                    b.Property<decimal?>("ServerCheckedTokenValue")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("服务端检查的值");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_UserChainTransaction_Id");

                    b.HasIndex("TokenId");

                    b.HasIndex("Uid");

                    b.HasIndex(new[] { "TransactionId" }, "IX_UserChainTransaction_TransactionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserInvitationRewardRecord", b =>
                {
                    ...
                    b.Property<int>("SubUserLayer")
                        .HasColumnType("int")
                        .HasComment("下级用户层级");

                    b.Property<decimal>("SubUserReward")
                        .HasColumnType("decimal(19, 6)")
                        .HasComment("下级用户奖励");

                    b.Property<int>("SubUserRewardType")
                        .HasColumnType("int")
                        .HasComment("奖励类型");

                    b.Property<int>("SubUserUid")
                        .HasColumnType("int")
                        .HasComment("下级用户ID");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_UserInvitationRewardRecord_Id");

                    b.HasIndex("SubUserUid");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserLevelConfig", b =>
                {
                    ...
                    b.Property<decimal>("AvailableAiTradingAssetsRate")
                    ...
                    b.Property<int>("DailyAiTradingLimitTimes")
                        .HasColumnType("int")
                        .HasComment("每日可进行AI合约交易次数");
                    ...
                    b.Property<decimal>("MaxEachAiTradingRewardRate")
                        .HasColumnType("decimal(5, 4)")
                        .HasComment("每次AI合约交易最大奖励比例");

                    b.Property<decimal>("MaxEachMiningRewardRate")
                        .HasColumnType("decimal(5, 4)")
                        .HasComment("每次挖矿奖励最大比例");

                    b.Property<decimal>("MinEachAiTradingRewardRate")
                        .HasColumnType("decimal(5, 4)")
                        .HasComment("每次AI合约交易最小奖励比例");

                    b.Property<decimal>("MinEachMiningRewardRate")
                        .HasColumnType("decimal(5, 4)")
                        .HasComment("每次挖矿奖励最小比例");

                    b.Property<decimal>("RequiresValidAsset")
                    ...
                    b.HasKey("UserLevel")
                        .HasName("PK_UserLevelConfig_UserLevel");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserMiningRewardRecord", b =>
                {
                    ...
                    b.Property<decimal>("ValidAssets")
                        .HasColumnType("decimal(19, 6)");

                    b.HasKey("Id")
                        .HasName("PK_UserMiningRewardRecord_Id");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserOnChainAssetsChange", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK_UserOnChainAssetsChange_Id");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.UserSysteamMessage", b =>
                {
                    ...
                    b.Property<bool>("IsActivationCodeMessage")
                        .HasColumnType("bit")
                        .HasComment("激活码消息");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_UserSysteamMessage_Id");

                    b.HasIndex("ActivationCodeGuid");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.Manager", b =>
                {
                    ...
                    b.Navigation("AttributionAgentU");

                    b.Navigation("AttributionGroupLeaderU");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ManagerOperationLog", b =>
                {
                    ...
                    b.Navigation("OperatorU");

                    b.Navigation("TargetManagerU");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ManagerTransferFromUserOrder", b =>
                {
                    ...
                    b.Navigation("OperationManagerU");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.User", b =>
                {
                    ...
                    b.Navigation("AttributionSalesmanU");

                    b.Navigation("Chain");

                    b.Navigation("ParentUserU");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.ChainTokenConfig", b =>
                {
                    ...
                    b.Navigation("UserAssetsToWalletOrders");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.Manager", b =>
                {
                    ...
                    b.Navigation("InverseAttributionGroupLeaderU");

                    b.Navigation("ManagerAiTradingActivationCodes");

                    b.Navigation("ManagerBalanceChanges");

                    b.Navigation("ManagerLoginLogs");

                    b.Navigation("ManagerOperationLogOperatorUs");

                    b.Navigation("ManagerOperationLogTargetManagerUs");

                    b.Navigation("ManagerTransferFromUserOrders");

                    b.Navigation("UserAssetsToWalletOrders");

                    b.Navigation("UserAttributionAgentUs");

                    b.Navigation("UserAttributionGroupLeaderUs");
            ...
            modelBuilder.Entity("UnifiedPlatform.DbService.Entities.User", b =>
                {
                    ...
                    b.Navigation("UserInvitationRewardRecordSubUserUs");

                    b.Navigation("UserInvitationRewardRecordUidNavigations");

                    b.Navigation("UserLoginLogs");

                    b.Navigation("UserMiningRewardRecords");

                    b.Navigation("UserOnChainAssetsChanges");

                    b.Navigation("UserPathNodeSubUserUs");
