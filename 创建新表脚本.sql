...
ELSE
BEGIN
    PRINT 'ProductReviews 表已存在，跳过创建';
END
GO
...
ELSE
BEGIN
    PRINT 'ProductSpecifications 表已存在，跳过创建';
END
GO
...
EXEC sys.sp_addextendedproperty 
    ...
    @level1type = N'TABLE', @level1name = N'ProductImages';
GO
...
EXEC sys.sp_addextendedproperty 
    ...
    @value = N'商品规格表', 
    @level0type = N'SCHEMA', @level0name = N'dbo', 
    @level1type = N'TABLE', @level1name = N'ProductSpecifications';
GO
